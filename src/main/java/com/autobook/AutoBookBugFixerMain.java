...
import com.autobook.core.AutoBookRequestPrinter;
import com.autobook.core.Printer;
...
public class AutoBookBugFixerMain {
     ...
     * @param args
     * @throws IOException
    *                     SELECT top 10  requestxml ,DataChange_LastTime,OrderId  FROM FMPDB..EXC_AutoBookRequest(NOLOCK)
    *                     WHERE Channel = 'CS-WS'
    ...
    *                     ORDER BY AutobookId DESC
    ...
    public static void main(String[] args) throws IOException {
        ...
        Printer<AutoBookRequest> printer = new AutoBookRequestPrinter();
